module.exports = function ({ data }) {
  ...
  lines.push("Pay attention not to declare multiple types in one line like `.type A, B`. Instead splits them into multiple lines one by one like `.type A .type B`");
