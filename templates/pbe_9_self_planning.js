module.exports = function ({ data }) {
  const { examples } = data;
  const lines = [];
  lines.push("Generate a single python function with a few helper function in it, which satisfies the following examples.")
  lines.push("Decompose the procedure into multiple steps by writing them as comments at the beginning of the output function")
